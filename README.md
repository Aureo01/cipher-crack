...
- python3 cipher_crack.py "SGVsbG8gV29ybGQ="

**Decode Base64 specifically**

- python3 cipher_crack.py "SGVsbG8=" --method base64

**Decode ROT13**

- python3 cipher_crack.py "Uryyb Jbeyq" --method rot13

**Decode Caesar (will try all shifts)**

- python3 cipher_crack.py "Khoor Zruog" --method caesar

**Decode Vigenère**

- python3 cipher_crack.py "Rijvs Asvph" --method vigenere
